...
- **Embedded adapters:** adapters are now selected directly on `AlarmUltimateState` / `AlarmUltimateZone` (no separate nodes). Current options: **Default**, **Homekit**, **Ax Pro (Hikvision Ultimate)**, **KNX-Ultimate**.
